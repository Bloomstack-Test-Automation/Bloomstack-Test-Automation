...
This pytest test was automatically generated by TestProject
    ...
    Test: CreateJobCard_TestCase1
    Generated by: Rahul Prakash (rahulprakash0862@gmail.com)
    Generated on 05/28/2021, 11:35:00
"""
...
def driver():
    driver = webdriver.Chrome(token="5o-UXmLZug6gaKmDcoeI6tT7NM19XyG1qnolFybLul4",
                              ...
                              job_name="CreateJobCard_TestCase1")
...
def test_main(driver):
    ...
    # 24. Click 'Flow Kana - Ship to HF  - VC8'
    flow_kana_ship_to_hf_vc8 = driver.find_element(By.XPATH,
                                                   "//li[. = 'Flow Kana - Ship to HF  - VC']")
    flow_kana_ship_to_hf_vc8.click()
    ...
    # 39. Scroll window by ('0','-600')
    driver.execute_script("window.scrollBy(0,-600)")

    # 40. Does 'Saved8' contain 'Saved'?
