...
This pytest test was automatically generated by TestProject
    ...
    Test: Customer_PricingRule_TestCase2
    Generated by: Meenal Kardale (meenal.kardale@extrapreneurs-india.com)
    Generated on 06/30/2021, 10:50:48
"""
...
def driver():
    driver = webdriver.Chrome(token="3J0RNM_48lLt_KM5Ab6s6A_HZzddmktVs_HhX77AjTM",
                              ...
                              job_name="Customer_PricingRule_TestCase2")
...
def test_main(driver):
    ...
    2. Open Customer.3. On Customer Dashboard , click on create -> pricing rule4. Enter title and select apply on as Item Group5. Add item group6. Select Selling Checkbox7. Select Min Qty, Max Qty, Min Amt and Max Amt8. Select Valid from , Valid upto and company9. Select rate or discount as discount percentage and enter discount percentage5. Save and Submit.
    """
    # Test Parameters
