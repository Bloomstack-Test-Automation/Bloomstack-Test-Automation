...
This pytest test was automatically generated by TestProject
    ...
    Test: SalesOrderToSalesInvoice_TestCase
    Generated by: Meenal Kardale (meenal.kardale@extrapreneurs-india.com)
    Generated on 06/30/2021, 10:49:56
"""
...
def driver():
    driver = webdriver.Chrome(token="3J0RNM_48lLt_KM5Ab6s6A_HZzddmktVs_HhX77AjTM",
                              ...
                              job_name="SalesOrderToSalesInvoice_TestCase")
...
def test_main(driver):
    ...
    2.Hit on New.3. Enter Customer , Company name and Expected Delivery Date 4. Select Delivery Warehouse5. Click on save and Submit6. Click on + icon next to Sales Invoice on the Dashboard7. Select Series 8. Click on Save and Submit.
    """
    # Test Parameters
    ...
    # 33. Does 'New Sales Invoice 11' contain 'New Sales Invoice 1'?
    ...
    # 34. Does 'Not Saved11' contain 'Not Saved'?
    ...
    # 36. Select the 'ACC-SINV-IND-YYYY.-' option in 'SELECT20'
    select20 = driver.find_element(By.XPATH,
                                   "//div[4]/div[2]/div[2]/div/div[3]/div[2]/div[1]/div[3]/div/div/div[2]/div[3]/div/div[1]/form/div[2]//select")
    ...
    # 40. Compares '{ExpectedCustName}' with '{ActualCustNmonSalesInvoiceScreen}'
    step_output = driver.addons().execute(
        StringUtils.comparetwostrings(
            firstString=f'{ExpectedCustName}',
    ...
    # 41. Compares '{ExpectedCompany}' with '{ActualCompOnSalesInvoiceScreen}'
    step_output = driver.addons().execute(
        StringUtils.comparetwostrings(
    ...
    # 44. Does 'draftstat' contain 'Draft'?
    ...
    # 48. Does 'Sales Invoice has been submitted succ...1' contain 'Sales Invoice has been submitted successfully'?
    ...
    # 51. Compares '{ExpectedCustName}' with '{ActualCustNmOnSalesInvoiceSubmit}'
    step_output = driver.addons().execute(
        StringUtils.comparetwostrings(
            firstString=f'{ExpectedCustName}',
