...
def driver():
    driver = webdriver.Chrome(token="3J0RNM_48lLt_KM5Ab6s6A_HZzddmktVs_HhX77AjTM",
                              ...
                              job_name="LeadToOpportunity_TestCase2")
...
def test_main(driver):
    ...
    2. Open Lead.3. Click on the \"\"+\"\" sign with Opportunity on Lead Dashboard.  It will redirect you to on Opportunity doctype.4. Save.
    """
    # Test Parameters
    ...
    # 46. Click 'clickplus'
    clickplus = driver.find_element(By.XPATH,
                                    "//div/div[1]/button/i")
    clickplus.click()
    ...
    # 57. Does 'Not Saved1' contain 'Not Saved'?
    not_saved1 = driver.find_element(By.XPATH,
                                     "//span/span[. = 'Not Saved']")
    step_output = not_saved1.text
    assert step_output and ("Not Saved" in step_output)

    # 58. Compares '{ExpectedLeadNm}' with '{ActualLeadName}'
    step_output = driver.addons().execute(
    ...
    # 59. Compares '{ExpectedLeadID}' with '{ActualLeadIDonOpportunityDoc}'
    step_output = driver.addons().execute(
        StringUtils.comparetwostrings(
    ...
    # 60. Compares '{ExpectedMobileNo}' with '{ActualMobileNoOnOpportunityDoc}'
    step_output = driver.addons().execute(
        StringUtils.comparetwostrings(
