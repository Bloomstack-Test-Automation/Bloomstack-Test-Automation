...
def driver():
    driver = webdriver.Chrome(token="3J0RNM_48lLt_KM5Ab6s6A_HZzddmktVs_HhX77AjTM",
                              ...
                              job_name="LeadToInvestor_TestCase2")
...
def test_main(driver):
    ...
    2. Open Lead.3. Click on the \"\"+\"\" sign with Investor on Lead Dashboard.  It will redirect you to on Investor doctype.4. Save.
    """
    # Test Parameters
    ...
    # 43. Click 'Clickplusicon'
    clickplusicon = driver.find_element(By.XPATH,
                                        "//div[3]/button/i")
    clickplusicon.click()
    ...
    # 47. Is 'Saved3' present?
    saved3 = driver.find_element(By.XPATH,
                                 "//div[3]/div[. = 'Saved']")

    # 48. Get text from 'PerName1'
    ...
    '''
    # (STEP DISABLED)
    # 49. Compares '{ExpectedLeadName}' with '{ActualLeadName}'
    step_output = driver.addons().execute(
    ...
    # 50. Compares '{ExpectedLeadName}' with '{ActualLeadNmonInvestor}'
    step_output = driver.addons().execute(
        StringUtils.comparetwostrings(
            firstString=f'{ExpectedLeadName}',
    ...
    # 51. Compares '{ExpectedLeadID}' with '{ActualLeadIDPartyNmOnInvest}'
    step_output = driver.addons().execute(
        StringUtils.comparetwostrings(
