...
This pytest test was automatically generated by TestProject
    ...
    Test: DeleteOperation_TestCase02
    Generated by: Rahul Prakash (rahulprakash0862@gmail.com)
    Generated on 05/26/2021, 04:25:23
"""
...
def driver():
    driver = webdriver.Chrome(token="5o-UXmLZug6gaKmDcoeI6tT7NM19XyG1qnolFybLul4",
                              ...
                              job_name="DeleteOperation_TestCase02")
...
def test_main(driver):
    ...
    # 12. Does 'Operation4' contain 'Operation'?
    operation4 = driver.find_element(By.XPATH,
                                     "//div[. = 'Operation']")
    step_output = operation4.text
    ...
    # 16. Type 'Tester EPI1' in 'INPUT52'
    input52 = driver.find_element(By.XPATH,
                                  "//form/div/div/div//input")
    ...
    driver.execute_script( "arguments[0].click();", input106)
    ...
    # 21. Get text from 'Delete 1 items permanently?'
    # Captured Delete Message
